/**
 * ONYXOS Holographic Materials
 * Shader materials for avatar surface and aura
 */

import * as THREE from 'three';
import { extend } from '@react-three/fiber';
import { ShaderUniforms, AuraUniforms } from '../../types/avatar';
...
// Import fragment shaders (will be loaded as strings)
...
export class HoloSurfaceMaterial extends THREE.ShaderMaterial {
  constructor() {
    super({
      ...
      uniforms: {
        u_time: { value: 0 },
        u_seasonColor: { value: new THREE.Color('#7A5CFF') },
        u_accent: { value: new THREE.Color('#7A5CFF') },
        u_xpPulse: { value: 0 },
...
export class AuraMaterial extends THREE.ShaderMaterial {
  constructor() {
    super({
      ...
      uniforms: {
        u_time: { value: 0 },
        u_color: { value: new THREE.Color('#7A5CFF') },
