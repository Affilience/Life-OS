  ...
  dashboard: {
    ...
    steps: [
      ...
      },
      {
        ...
        content: "Here you can see your level, XP progress, and current streak. Every action you take in LifeOS earns you experience points!",
    ...
    steps: [
      {
        ...
        content: "This is YOU in LifeOS - your character grows as you grow. Let me show you how to customize your avatar, equip gear, unlock perks, and adopt companions!",
        novaState: NOVA_STATES.EXCITED,
        position: 'center',
      },
      {
  ...
  knowledge: {
    ...
    steps: [
      ...
      },
      {
        ...
        title: 'Notes Tab',
        content: "Click the Notes tab to write and organize your notes. This is where you capture learnings and ideas!",
        novaState: NOVA_STATES.ENCOURAGING,
        position: POSITIONS.BOTTOM,
        action: 'click',
      },
  ...
  calendar: {
    ...
    steps: [
      ...
      },
      {
        ...
        content: "Switch between Week and Day views. Week view shows your full schedule at a glance, while Day view lets you focus on today's time blocks.",
        novaState: NOVA_STATES.HAPPY,
        position: POSITIONS.BOTTOM,
      },
      {
      ...
      },
      {
        ...
        content: "Click to create a new time block. Set the activity, duration, and category. Your calendar becomes your game plan!",
        novaState: NOVA_STATES.ENCOURAGING,
        position: POSITIONS.BOTTOM,
        action: 'click',
      },
      {
        ...
        target: null,
        title: 'Own Your Time!',
        content: "What gets scheduled gets done. Plan your day the night before and wake up with purpose!",
        novaState: NOVA_STATES.PROUD,
        position: 'center',
      },
    ],
  ...
  journal: {
    ...
    steps: [
      ...
      },
      {
        ...
        content: "Make it yours! Click here to customize your journal cover - choose colors, textures, icons, and set your journal's title.",
        novaState: NOVA_STATES.ENCOURAGING,
        position: POSITIONS.BOTTOM,
        action: 'click',
      },
      {
        ...
        content: "Click here to start writing! You'll be able to add a title, write your thoughts, track your mood, and add tags to organize entries.",
        novaState: NOVA_STATES.ENCOURAGING,
        position: POSITIONS.BOTTOM,
        action: 'click',
      },
