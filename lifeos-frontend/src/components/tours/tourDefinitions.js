  ...
  dashboard: {
    ...
    steps: [
      ...
      },
      {
        ...
        title: 'Quick Actions',
        content: "Need to log something fast? These buttons let you quickly add tasks, meals, or start a workout without navigating away.",
        novaState: NOVA_STATES.HAPPY,
  ...
  productivity: {
    ...
    steps: [
      ...
      },
      {
        ...
        title: 'Your Tasks',
        content: "Your daily to-dos live here. Tasks can be standalone or linked to projects. Completing tasks earns you XP!",
        novaState: NOVA_STATES.HAPPY,
    ...
    steps: [
      {
        ...
        content: "Every expert was once a beginner. Track your skills, log practice time, and watch your constellation of abilities grow!",
        novaState: NOVA_STATES.EXCITED,
        position: 'center',
      },
      {
        ...
        content: "Your skills form a constellation in the cosmos. Each skill is a star - the brighter it shines, the more you've practiced!",
        novaState: NOVA_STATES.HAPPY,
        position: POSITIONS.BOTTOM,
      },
      {
        ...
        title: 'Skill Details',
        content: "Click any skill to see your progress, practice history, and set goals. Deliberate practice is the key to mastery!",
        novaState: NOVA_STATES.THOUGHTFUL,
        position: POSITIONS.LEFT,
      },
      {
        ...
        title: 'Adding Skills',
        content: "Click here to add a new skill you're developing. Track anything - coding, music, languages, sports, art, anything!",
        novaState: NOVA_STATES.ENCOURAGING,
        position: POSITIONS.BOTTOM,
        action: 'click',
      },
      {
        ...
        content: "10,000 hours of practice leads to mastery. Start logging your practice time and watch your skills level up!",
        novaState: NOVA_STATES.PROUD,
        position: 'center',
      },
    ],
  ...
  purpose: {
    ...
    steps: [
      ...
      },
      {
        ...
        content: "You have five main areas: Overview for a summary, Mission for your life purpose, Values for what matters most, Vision for future goals, and Decisions to track important choices.",
        novaState: NOVA_STATES.HAPPY,
        position: POSITIONS.BOTTOM,
      },
      {
        id: 'overview-tab',
        target: '[data-tour="purpose-tab-overview"]',
        title: 'Overview Tab',
        content: "The Overview shows your purpose at a glance - mission statement, top values, and recent decisions. Let's start here!",
        novaState: NOVA_STATES.ENCOURAGING,
        position: POSITIONS.BOTTOM,
        action: 'click',
      },
      {
        ...
        title: 'Purpose Stats',
        content: "See your key metrics - how many values you've defined, decisions logged, and your decision quality score. These help you track intentional living!",
        novaState: NOVA_STATES.HAPPY,
        position: POSITIONS.BOTTOM,
      },
      {
      ...
      {
        id: 'decisions-tab',
        target: '[data-tour="purpose-tab-decisions"]',
        title: 'Decisions Tab',
        content: "Click the Decisions tab to keep a decision journal. Tracking important decisions helps you learn from outcomes!",
        novaState: NOVA_STATES.ENCOURAGING,
        position: POSITIONS.BOTTOM,
        action: 'click',
      },
      {
        ...
        target: '[data-tour="purpose-decisions-section"]',
        title: 'Decision Journal',
        content: "Log important decisions here with context, chosen option, and expected outcomes. Later, review decisions to see what worked and extract lessons learned!",
        novaState: NOVA_STATES.HAPPY,
        position: POSITIONS.TOP,
      },
      {
        id: 'log-decision',
        target: '[data-tour="log-decision-btn"]',
        title: 'Logging Decisions',
        content: "Click here to log a new decision. Rate its importance, categorize it, and document your reasoning. Future you will thank you for this clarity!",
        novaState: NOVA_STATES.ENCOURAGING,
        position: POSITIONS.BOTTOM,
        action: 'click',
      },
      {
        ...
        content: "You've seen how to define your mission, values, vision, and track decisions. When you know your Why, the How becomes clear. Start defining your North Star!",
        novaState: NOVA_STATES.PROUD,
        position: 'center',
      },
    ],
