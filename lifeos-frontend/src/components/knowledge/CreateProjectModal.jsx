...
export default function CreateProjectModal({ onClose }) {
  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-zinc-900 border border-purple-500/30 rounded-xl shadow-2xl w-full max-w-2xl overflow-hidden">
        {/* Header */}
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-zinc-400">Launch a new mission into the cosmos</p>
              </div>
            </div>
            <button
              onClick={onClose}
          ...
          <div>
            ...
            <div className="grid grid-cols-3 gap-3">
              ...
              >
                ...
                <div className="text-xs text-zinc-500 mt-1">Planning</div>
              </button>
              <button
                type="button"
