            ...
            <div className="mt-4 flex items-center justify-between">
              ...
              <button
                onClick={() => {
                  ...
                  if (notes !== getNotesAsString(media?.textNotes ?? media?.notes)) {
                    updateMedia(mediaId, { textNotes: notes });
                  }
                  setActiveView('media');
                }}
                className="flex items-center gap-2 px-4 py-2 bg-green-500 hover:bg-green-600 hover:shadow-[0_8px_32px_rgba(34,197,94,0.3)] hover:-translate-y-[1px] active:translate-y-0 text-white font-medium rounded-lg transition-all duration-150"
              >
