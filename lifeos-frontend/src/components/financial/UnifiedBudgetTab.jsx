...
function CreateBudgetModal({ selectedMonth, monthBudgets, onClose, onSave, onCopyFromPrevious }) {
  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-start sm:items-center justify-center pt-8 sm:pt-4 px-4 pb-4">
      <div className="bg-[#12101a] border border-slate-700 rounded-2xl max-w-2xl w-full max-h-[85vh] sm:max-h-[90vh] flex flex-col shadow-2xl">
        {/* Header */}
