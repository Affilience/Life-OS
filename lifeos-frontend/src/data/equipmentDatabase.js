...
export const EQUIPMENT_DATABASE = {
  ...
  chest_void_platemail: {
    ...
    slot: 'chest',
    rarity: 'mythical',
    description: 'Armor forged from the essence of the void',
  ...
  chest_crystal_aegis: {
    ...
    slot: 'chest',
    rarity: 'mythical',
    description: 'Crystalline armor embedded with frost crystals',
  ...
  chest_celestial_raiment: {
    ...
    slot: 'chest',
    rarity: 'mythical',
    description: 'Divine armor blessed by the celestial beings',
  ...
  chest_abyssal_cuirass: {
    ...
    slot: 'chest',
    rarity: 'mythical',
    description: 'Armor from the depths of the abyss',
  ...
  chest_stormforged_breastplate: {
    ...
    slot: 'chest',
    rarity: 'mythical',
    description: 'Steel armor crackling with lightning',
  ...
  chest_infernal_harness: {
    ...
    slot: 'chest',
    rarity: 'mythical',
    description: 'Demonic armor with molten lava veins',
  ...
  legs_void_greaves: {
    ...
    slot: 'legs',
    rarity: 'mythical',
    description: 'Dark leg armor with shadow tendrils and glowing runes',
  ...
  legs_crystal_legguards: {
    ...
    slot: 'legs',
    rarity: 'mythical',
    description: 'Crystalline leg armor embedded with frost crystals',
  ...
  legs_celestial_tassets: {
    ...
    slot: 'legs',
    rarity: 'mythical',
    description: 'Divine golden leg armor with angelic feather motifs',
  ...
  legs_abyssal_cuisses: {
    ...
    slot: 'legs',
    rarity: 'mythical',
    description: 'Deep sea leg armor with bioluminescent patterns',
  ...
  legs_stormforged_greaves: {
    ...
    slot: 'legs',
    rarity: 'mythical',
    description: 'Electrified steel leg armor with lightning patterns',
  ...
  legs_infernal_legguards: {
    ...
    slot: 'legs',
    rarity: 'mythical',
    description: 'Demonic leg armor with molten lava cracks',
