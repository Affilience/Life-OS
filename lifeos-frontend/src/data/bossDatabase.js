...
export const BOSS_DATABASE = {
  ...
  // ========================================
  // ENDGAME BOSSES (Level 50+) - Drop rare abilities
  // ========================================
  void_titan: {
    id: 'void_titan',
    name: 'Void Titan',
    ...
    xpReward: 5000,
    creditsReward: 2500,
    sprite: '/assets/bosses/boss_void_titan.png',
    description: 'A colossal being from the void between realities',
    lore: 'The Void Titan exists in the space between achievement and failure, challenging those who dare to transcend.',
    attackAnimation: 'voidblast',
    attackName: 'Reality Tear',
    attackDescription: 'Rips open a tear in reality, unleashing devastating void energy',
    attackColor: '#1e1b4b',
    abilityDrops: ['black_hole', 'void_collapse'],
  },
  celestial_guardian: {
    ...
    xpReward: 6000,
    creditsReward: 3000,
    sprite: '/assets/bosses/boss_celestial_guardian.png',
    description: 'An angelic protector of the celestial realm',
    lore: 'Sent to test the worthiest warriors, only those with true dedication may pass.',
    attackAnimation: 'divinestrike',
    attackName: 'Judgment Ray',
    attackDescription: 'A beam of pure celestial energy that pierces all defenses',
    attackColor: '#fef08a',
    abilityDrops: ['divine_judgment'],
  },
  archangel: {
    id: 'archangel',
    name: 'Archangel',
    ...
    xpReward: 7500,
    creditsReward: 3750,
    sprite: '/assets/bosses/boss_archangel.png',
    description: 'A supreme angelic being of immense power',
    lore: 'The Archangel descends only for those who have proven themselves masters of their destiny.',
    attackAnimation: 'holyfire',
    attackName: 'Divine Wrath',
    attackDescription: 'Unleashes the fury of the heavens upon the unworthy',
    attackColor: '#fbbf24',
    abilityDrops: ['angels_wrath'],
  },
  solar_emperor: {
    id: 'solar_emperor',
    name: 'Solar Emperor',
    ...
    xpReward: 10000,
    creditsReward: 5000,
    sprite: '/assets/bosses/boss_solar_emperor.png',
    description: 'The embodiment of the sun\'s power',
    lore: 'Ruler of the Solar Court, this emperor\'s flames forge champions from mere mortals.',
    attackAnimation: 'solarflare',
    attackName: 'Corona Blast',
    attackDescription: 'A devastating eruption of solar energy that incinerates all in its path',
    attackColor: '#f97316',
    abilityDrops: ['supernova'],
  },
  frost_monarch: {
    id: 'frost_monarch',
    name: 'Frost Monarch',
    ...
    xpReward: 10000,
    creditsReward: 5000,
    sprite: '/assets/bosses/boss_frost_monarch.png',
    description: 'The eternal ruler of the frozen wastes',
    lore: 'Time freezes in the presence of the Frost Monarch. Only the most persistent can withstand the cold.',
    attackAnimation: 'blizzard',
    attackName: 'Eternal Winter',
    attackDescription: 'Summons an endless blizzard that saps the will to continue',
    attackColor: '#38bdf8',
    abilityDrops: ['absolute_zero'],
  },
  storm_lord: {
    id: 'storm_lord',
    name: 'Storm Lord',
    ...
    xpReward: 10000,
    creditsReward: 5000,
    sprite: '/assets/bosses/boss_storm_lord.png',
    description: 'Master of thunder and lightning',
    lore: 'Commands the fury of a thousand storms. Those who face him must weather the tempest within.',
    attackAnimation: 'thunderstorm',
    attackName: 'Tempest Fury',
    attackDescription: 'Calls down a cataclysmic storm that strikes with divine fury',
    attackColor: '#a78bfa',
    abilityDrops: ['divine_storm'],
  },
  elemental_king: {
    id: 'elemental_king',
    name: 'Elemental King',
    ...
    xpReward: 15000,
    creditsReward: 7500,
    sprite: '/assets/bosses/boss_elemental_king.png',
    description: 'The ultimate master of all elements',
    lore: 'The Elemental King is the final challenge. Only true masters of self who have conquered all elements may face him.',
    attackAnimation: 'elementalfury',
    attackName: 'Elemental Convergence',
    attackDescription: 'Combines all elemental forces into one devastating attack',
    attackColor: '#ec4899',
    abilityDrops: ['elemental_fury'],
  },
};
