...
export const EQUIPMENT_DATABASE = {
  ...
  helmet_visor: {
    ...
    tier: 2,
    rarity: 'uncommon',
    unlockedBy: { module: 'productivity', requirement: 'complete_50_tasks' },
  ...
  helmet_hud: {
    ...
    tier: 2,
    rarity: 'rare',
    unlockedBy: { module: 'knowledge', requirement: 'finish_10_books' },
  ...
  helmet_neural: {
    ...
    tier: 3,
    rarity: 'epic',
    unlockedBy: { module: 'knowledge', requirement: 'master_5_skills' },
  ...
  helmet_omniscient: {
    ...
    tier: 4,
    rarity: 'legendary',
    unlockedBy: { module: 'cross', requirement: '100_hours_learning' },
  ...
  suit_reinforced: {
    ...
    tier: 2,
    rarity: 'uncommon',
    unlockedBy: { module: 'fitness', requirement: '30_workouts_completed' },
  ...
  suit_biometric: {
    ...
    tier: 2,
    rarity: 'rare',
    unlockedBy: { module: 'fitness', requirement: 'hit_macros_30_days' },
  ...
  suit_adaptive: {
    ...
    tier: 3,
    rarity: 'epic',
    unlockedBy: { module: 'fitness', requirement: '90_day_workout_streak' },
  ...
  suit_cosmic: {
    ...
    tier: 4,
    rarity: 'legendary',
    unlockedBy: { module: 'cross', requirement: 'all_modules_90_days' },
  ...
  backpack_endurance: {
    ...
    tier: 2,
    rarity: 'uncommon',
    unlockedBy: { module: 'fitness', requirement: '10k_steps_streak' },
  ...
  backpack_quantum: {
    ...
    tier: 3,
    rarity: 'epic',
    unlockedBy: { module: 'productivity', requirement: 'complete_500_tasks' },
  ...
  backpack_cosmic: {
    ...
    tier: 4,
    rarity: 'legendary',
    unlockedBy: { module: 'cross', requirement: 'prestige_unlock' },
  ...
  tool_tablet: {
    ...
    tier: 1,
    rarity: 'uncommon',
    unlockedBy: { module: 'productivity', requirement: '20_tasks_completed' },
  ...
  tool_quantum_planner: {
    ...
    tier: 2,
    rarity: 'rare',
    unlockedBy: { module: 'productivity', requirement: '200_tasks_completed' },
  ...
  tool_value_predictor: {
    ...
    tier: 2,
    rarity: 'rare',
    unlockedBy: { module: 'financial', requirement: '30_days_tracked' },
  ...
  tool_time_dilation: {
    ...
    tier: 3,
    rarity: 'epic',
    unlockedBy: { module: 'calendar', requirement: '30_days_perfect_schedule' },
  ...
  tool_omniscient_analyzer: {
    ...
    tier: 4,
    rarity: 'legendary',
    unlockedBy: { module: 'cross', requirement: 'complete_all_achievements' },
  ...
  badge_productivity: {
    ...
    tier: 2,
    rarity: 'rare',
    unlockedBy: { module: 'productivity', requirement: '30_day_streak' },
    stats: { intelligence: 2 },
  ...
  badge_fitness: {
    ...
    tier: 2,
    rarity: 'rare',
    unlockedBy: { module: 'fitness', requirement: 'all_macros_60_days' },
  ...
  badge_knowledge: {
    ...
    tier: 2,
    rarity: 'rare',
    unlockedBy: { module: 'knowledge', requirement: '50_books_read' },
  ...
  badge_cosmic: {
    ...
    tier: 4,
    rarity: 'legendary',
    unlockedBy: { module: 'cross', requirement: 'master_all_modules' },
