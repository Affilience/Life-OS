...
export const HERO_STAGES = {
  ...
  1: {
    ...
    sprite: 'evolution/hero_stage_1_dreamer.png',
  ...
  2: {
    ...
    act: 1,
    actName: 'The Awakening',
    sprite: 'evolution/hero_stage_2_seeker.png',
  ...
  3: {
    ...
    act: 1,
    actName: 'The Awakening',
    sprite: 'evolution/hero_stage_3_recruit.png',
  ...
  4: {
    ...
    act: 1,
    actName: 'The Awakening',
    sprite: 'evolution/hero_stage_4_trainee.png',
  ...
  5: {
    ...
    act: 1,
    actName: 'The Awakening',
    sprite: 'evolution/hero_stage_5_squire.png',
  ...
  6: {
    ...
    act: 1,
    actName: 'The Awakening',
    sprite: 'evolution/hero_stage_6_initiate.png',
  ...
  7: {
    ...
    act: 1,
    actName: 'The Awakening',
    sprite: 'evolution/hero_stage_7_footman.png',
  ...
  8: {
    ...
    act: 1,
    actName: 'The Awakening',
    sprite: 'evolution/hero_stage_8_scout.png',
  ...
  9: {
    ...
    act: 1,
    actName: 'The Awakening',
    sprite: 'evolution/hero_stage_9_warrior.png',
  ...
  10: {
    ...
    act: 1,
    actName: 'The Awakening',
    sprite: 'evolution/hero_stage_10_swordsman.png',
  ...
  11: {
    ...
    act: 2,
    actName: 'The Trials',
    sprite: 'evolution/hero_stage_11_duelist.png',
  ...
  12: {
    ...
    act: 2,
    actName: 'The Trials',
    sprite: 'evolution/hero_stage_12_berserker.png',
  ...
  13: {
    ...
    act: 2,
    actName: 'The Trials',
    sprite: 'evolution/hero_stage_13_knight.png',
  ...
  14: {
    ...
    act: 2,
    actName: 'The Trials',
    sprite: 'evolution/hero_stage_14_ranger.png',
  ...
  15: {
    ...
    act: 2,
    actName: 'The Trials',
    sprite: 'evolution/hero_stage_15_paladin.png',
  ...
  16: {
    ...
    act: 2,
    actName: 'The Trials',
    sprite: 'evolution/hero_stage_16_monk.png',
  ...
  17: {
    ...
    act: 2,
    actName: 'The Trials',
    sprite: 'evolution/hero_stage_17_assassin.png',
  ...
  18: {
    ...
    act: 2,
    actName: 'The Trials',
    sprite: 'evolution/hero_stage_18_battlemage.png',
  ...
  19: {
    ...
    act: 2,
    actName: 'The Trials',
    sprite: 'evolution/hero_stage_19_champion.png',
  ...
  20: {
    ...
    act: 2,
    actName: 'The Trials',
    sprite: 'evolution/hero_stage_20_veteran.png',
  ...
  21: {
    ...
    act: 3,
    actName: 'Mastery',
    sprite: 'evolution/hero_stage_21_blade_master.png',
  ...
  22: {
    ...
    act: 3,
    actName: 'Mastery',
    sprite: 'evolution/hero_stage_22_war_chief.png',
  ...
  23: {
    ...
    act: 3,
    actName: 'Mastery',
    sprite: 'evolution/hero_stage_23_dragon_knight.png',
  ...
  24: {
    ...
    act: 3,
    actName: 'Mastery',
    sprite: 'evolution/hero_stage_24_shadow_master.png',
  ...
  25: {
    ...
    act: 3,
    actName: 'Mastery',
    sprite: 'evolution/hero_stage_25_holy_crusader.png',
  ...
  26: {
    ...
    act: 3,
    actName: 'Mastery',
    sprite: 'evolution/hero_stage_26_arcane_warrior.png',
  ...
  27: {
    ...
    act: 3,
    actName: 'Mastery',
    sprite: 'evolution/hero_stage_27_beast_master.png',
  ...
  28: {
    ...
    act: 3,
    actName: 'Mastery',
    sprite: 'evolution/hero_stage_28_demon_hunter.png',
  ...
  29: {
    ...
    act: 3,
    actName: 'Mastery',
    sprite: 'evolution/hero_stage_29_storm_lord.png',
  ...
  30: {
    ...
    act: 3,
    actName: 'Mastery',
    sprite: 'evolution/hero_stage_30_warlord.png',
    colors: { primary: '#DC2626', secondary: '#FCD34D', accent: '#991B1B' },
  },
  ...
  31: {
    ...
    act: 4,
    actName: 'Legend',
    sprite: 'evolution/hero_stage_31_sword_saint.png',
  ...
  32: {
    ...
    act: 4,
    actName: 'Legend',
    sprite: 'evolution/hero_stage_32_phoenix_knight.png',
  ...
  33: {
    ...
    act: 4,
    actName: 'Legend',
    sprite: 'evolution/hero_stage_33_void_stalker.png',
  ...
  34: {
    ...
    act: 4,
    actName: 'Legend',
    sprite: 'evolution/hero_stage_34_celestial_guardian.png',
    colors: { primary: '#FCD34D', secondary: '#F3F4F6', accent: '#F59E0B' },
  },
  35: {
    id: 'titan_slayer',
    ...
    act: 4,
    actName: 'Legend',
    sprite: 'evolution/hero_stage_35_titan_slayer.png',
  ...
  36: {
    ...
    act: 4,
    actName: 'Legend',
    sprite: 'evolution/hero_stage_36_elemental_lord.png',
  ...
  37: {
    ...
    act: 4,
    actName: 'Legend',
    sprite: 'evolution/hero_stage_37_immortal_champion.png',
  ...
  38: {
    ...
    act: 4,
    actName: 'Legend',
    sprite: 'evolution/hero_stage_38_godslayer.png',
  ...
  39: {
    ...
    act: 4,
    actName: 'Legend',
    sprite: 'evolution/hero_stage_39_ascendant.png',
  ...
  40: {
    ...
    act: 4,
    actName: 'Legend',
    sprite: 'evolution/hero_stage_40_avatar_of_mastery.png',
    colors: { primary: '#F3F4F6', secondary: '#FCD34D', accent: '#7C3AED', tertiary: '#DC2626', quaternary: '#10B981' },
  },
};

// Helper function to get current stage based on level
export const getCurrentHeroStage = (level) => {
  const stages = Object.values(HERO_STAGES);
  // Find the highest stage the user qualifies for
  const qualifiedStages = stages.filter(stage => level >= stage.levelRequired);
  return qualifiedStages[qualifiedStages.length - 1] || HERO_STAGES[1];
};

// Helper function to get next stage
export const getNextHeroStage = (currentLevel) => {
  const stages = Object.values(HERO_STAGES);
  return stages.find(stage => stage.levelRequired > currentLevel);
};
...
export const getStagesByAct = (actNumber) => {
  return Object.values(HERO_STAGES).filter(stage => stage.act === actNumber);
};
