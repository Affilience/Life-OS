      ...
      <div ref={footerRef} className="relative z-20 border-t border-white/5 px-6 py-6" style={{ opacity: 0 }}>
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-semibold text-white">Ascnt</span>
          </div>
          ...
          <div className="flex items-center gap-4">
            <div className="flex gap-3">
              <a href="https://twitter.com/ascntapp" className="text-white/30 hover:text-white transition-colors">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                </svg>
              </a>
              <a href="https://discord.gg/ascnt" className="text-white/30 hover:text-white transition-colors">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
            ...
            <span className="text-white/20 text-xs">© 2025 Ascnt</span>
          </div>
        </div>
      </div>
    </section>
